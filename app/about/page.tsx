                ...
                <div className="md:flex-1 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <div className="flex flex-col items-center bg-white rounded-lg shadow-sm p-4 text-center cursor-pointer">
                            <FontAwesomeIcon icon={faAward} className="text-3xl text-brand-green mb-2" />
                        ...
                        <div className="flex flex-col items-center bg-white rounded-lg shadow-sm p-4 text-center cursor-pointer">
                            <FontAwesomeIcon icon={faUsers} className="text-3xl text-brand-green mb-2" />
                            <h5 className="font-semibold text-black">
                                Clients
                            </h5>
                            <small className="text-black/70">
                        ...
                        <div className="flex flex-col items-center bg-white rounded-lg shadow-sm p-4 text-center cursor-pointer">
                            <FontAwesomeIcon icon={faDiagramProject} className="text-3xl text-brand-green mb-2" />
                            <h5 className="font-semibold text-black">
                                Projects
                            </h5>
                            <small className="text-black/70">
                    ...
                    <div className="space-y-4 text-black/70">
                        ...
                        <p>
                            ...
                            professional UI/UX, fast load times,
                        ...
                        <p>
                            ...
                            refining the craft of user-centered
                            development.
                        </p>
                    </div>
                    {/* CTA Button */}
