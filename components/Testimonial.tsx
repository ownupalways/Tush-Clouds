...
export default function Testimonial() {
  ...
  return (
    <section id="testimonial" className="py-12 md:py-20 bg-gray-50 dark:bg-gray-900/50">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        
        {/* Header Section */}
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
            Client <span className="text-brand-green dark:text-brand-lemon">Feedback</span>
          </h2>
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8">
            Hear from partners who have experienced our commitment to excellence first-hand.
          </p>

          <div className="flex flex-wrap justify-center gap-4">
            <AddReviewButton type="testimonial" onSuccess={handleReviewSuccess} />
            <Link
              href="/testimonials"
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white dark:bg-gray-800 rounded-3xl border border-dashed border-gray-300 dark:border-gray-700">
            ...
            <h3 className="text-xl font-bold mb-2 dark:text-white">No testimonials yet</h3>
          ...
          >
            {testimonials.map((t) => (
              <SwiperSlide key={t._id} className="h-auto">
                <div className="flex flex-col h-full p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:border-brand-green dark:hover:border-brand-lemon transition-colors duration-300">
                  <div className="grow">
                    <FontAwesomeIcon
                      icon={faQuoteLeft}
                    ...
                    <div className="flex gap-1 mb-8">
                      {[...Array(5)].map((_, i) => (
                        <FontAwesomeIcon
                          ...
                          icon={faStar}
                          className={`text-sm ${
                            i < (t.rating ?? 5) ? "text-brand-lemon" : "text-gray-200 dark:text-gray-700"
                          }`}
                        />
                      ))}
                    </div>
                  ...
                  <div className="flex items-center gap-4 pt-6 border-t border-gray-100 dark:border-gray-700">
                    <div className="relative w-12 h-12 rounded-full overflow-hidden ring-2 ring-brand-green/20 dark:ring-brand-lemon/20 shrink-0">
                      <Image
                        src={t.image || getAvatarUrl(t.name)}
                        alt={t.name}
                        fill
                    ...
                    <div className="overflow-hidden">
                      <h5 className="font-bold text-gray-900 dark:text-white truncate">{t.name}</h5>
